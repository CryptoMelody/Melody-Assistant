#MELODY Current Version is 5.0 - Turbo 
...
def process_command(command):
    ...
    #CHAT-GPT:
    elif command.lower().startswith("jarvis"):
        l = command[:7].strip()
        response = client.chat.completions.create(
            model = "bailian/qwen3.6-flash",
            messages = [{"role": "user", "content": l},],
            )
        voice_box(response.choices[0].message.content, "fe0c18ee-a2db-459b-b8d6-125a92142a31")
